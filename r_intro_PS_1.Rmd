...
population_mean<-mean(df$Sepal.Length)

typeof(population_mean)
...
set.seed(3456)
mean_list_1=replicate(n=100,expr=mean(sample(df$Sepal.Length,size=10,replace=TRUE)))

mean_list_2=replicate(n=200,expr=mean(sample(df$Sepal.Length,size=30,replace=TRUE)))

mean_list_3=replicate(n=1000,expr=mean(sample(df$Sepal.Length,size=50,replace=TRUE)))


mean_compare<-c("population mean"=population_mean,
                "mean_list_1"=mean(mean_list_1),
                "mean_list_2"=mean(mean_list_2),
                "mean_list_3"=mean(mean_list_3)
                )
mean_compare
